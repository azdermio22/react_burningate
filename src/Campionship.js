            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-4 p-0">
                        <div className="competition bg-danger text-center pt-3 scale_side_slide left_slide">
                    ...
                    <div className="competition bg-danger text-center pt-3 center_slide">
                    <div className="text-white fs-3">CALISTHENICS OFFICIAL CIRCUIT & MILAN</div>
                        <div className="text-white fs-3">25/12/2024</div>
                        <button className="competition_button">MORE INFO</button>
                    ...
                    <div className="competition bg-danger text-center pt-3 position-absolute back_slide">
                    <div className="text-white fs-3">CALISTHENICS OFFICIAL CIRCUIT & MILAN</div>
                        <div className="text-white fs-3">25/12/2024</div>
                        <button className="competition_button">MORE INFO</button>
                    <div className="logo_white"></div>
